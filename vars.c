 ...
 */
int is_chain(cmd_t *info, char *buf, size_t *p)
{
	size_t j = *p;
 ...
 * Return: Void
 */
void check_chain(cmd_t *info, char *buf, size_t *p, size_t i, size_t len)
{
	size_t j = *p;
